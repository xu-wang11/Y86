...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	  IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, IIADDL, ILEAVE, IEXCHANGE };
...
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL, IIADDL, IEXCHANGE };

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, IIADDL, IEXCHANGE };
...
int d_srcA = [
	D_icode in { IRRMOVL, IRMMOVL, IOPL, IPUSHL, IEXCHANGE  } : D_rA;
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IMRMOVL, IIADDL, IEXCHANGE } : D_rB;
...
int d_dstM = [
	D_icode in { ILEAVE } : REBP;
	D_icode in { IMRMOVL, IPOPL, IEXCHANGE } : D_rA;
	1 : RNONE;  # Don't write any register
];
...
int aluA = [
	...
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL, IEXCHANGE } : E_valC;
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		     IPUSHL, IRET, IPOPL, IIADDL, ILEAVE, IEXCHANGE } : E_valB;
...
int mem_addr = [
	M_icode in { IRMMOVL, IPUSHL, ICALL, IMRMOVL, IEXCHANGE } : M_valE;
	M_icode in { IPOPL, IRET, ILEAVE } : M_valA;
	# Other instructions don't need address
];

## Set read control signal
bool mem_read = M_icode in { IMRMOVL, IPOPL, IRET, ILEAVE, IEXCHANGE };

## Set write control signal
bool mem_write = M_icode in { IRMMOVL, IPUSHL, ICALL, IEXCHANGE };
...
bool F_stall =
	...
	E_icode in { IMRMOVL, IPOPL, ILEAVE, IEXCHANGE } &&
...
bool D_bubble =
	...
	!(E_icode in { IMRMOVL, IPOPL, ILEAVE, IEXCHANGE } && E_dstM in { d_srcA, d_srcB }) &&
	  IRET in { D_icode, E_icode, M_icode };
